app.config(function ($routeProvider, $locationProvider, $validatorProvider) {
    ...
    $routeProvider
        .when('/Home', {
            templateUrl: ctxfolderurl + '/Home.html',
            controller: 'Activity',
        })
...
app.controller('Activity', function ($scope, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, dataservice, $uibModal, $filter) {
